...
|------|-------------|------|---------|:--------:|
| allowed\_cidrs | List of allowed CIDR ranges to access the Azure Virtual Desktop resource. | `list(string)` | `[]` | no |
| allowed\_subnet\_ids | List of allowed subnets IDs to access the Azure Virtual Desktop resource. | `list(string)` | `[]` | no |
...
| public\_network\_access\_enabled | Whether the Azure Virtual Desktop is available from public network. | `bool` | `false` | no |
...
| identity\_principal\_id | Azure Virtual Desktop system identity principal ID |
